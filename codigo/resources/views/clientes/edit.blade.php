...
@section('titulo', 'Editar Clentes')
@section('h1', 'Editar Clientes')
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card mt-2 mx-auto p-4 bg-light">
                    <div class="card-body d-flex justify-content-center">
                        <form id="contact-form" role="form" method="POST" action="{{route("clientes.update", $cliente->id)}}">
                            @method('PUT')
                            @csrf
                            <div class="controls">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="debito" id="debito" class="form-control"
                                                required="required" value="{{$cliente->debito}}">
                                        </div>
                                    </div>
                                </div>
