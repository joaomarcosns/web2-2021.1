    ...
    <form class="form form-venda" action="{{ route("vendas.store") }}" id="form" method="post">
        ...
        <div class="form-group">
            <div class="input-produto-quant d-flex justify-content-between">
                ...
                <div class="input">
                    ...
                    <input type="number" min="1" value="0" name="quantidade[]" class="form-control @error('quantidade') is-invalid @enderror" required oninput="setValor(this)">
                    @error('quantidade')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="input">
                    ...
                    <input type="text" class="form-control valor-unid" value="R$ 0.00" disabled>
                </div>
                <div class="input">
        ...
        <div class="input-submit d-flex justify-content-between">
            <div class="input" style="width: 70%">
                ...
                <input type="text" value="R$ 0.00" class="form-control valor-total-venda" disabled>
            </div>
